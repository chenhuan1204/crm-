...
/* window.onload = function () {}页面加载成功以后 */
	window.onload = function () {
		...
		if (top.location != self.location) {//如果顶部的地址和自己的四肢不一样
			//最大地址栏地址和自己的地址不一样，将自己的地址赋值给最大的
			top.location = self.location;//就将自己给地址栏
		}
	}
</script>
<script>
	function change(){
        ...
        img.src = "<?=$Verify['url']?>?rnd=" + Math.random();
	}
</script>
...
<TABLE cellSpacing=0 cellPadding=0 width=900 align=center border=0>
  ...
  <TR>
          ...
          <TD>
            ...
            <TABLE cellSpacing=0 cellPadding=2 border=0>
              ...
              <TR>
                ...
                <TD style="HEIGHT: 28px" width=370><SPAN 
                  id=RequiredFieldValidator3 
                  style="FONT-WEIGHT: bold; VISIBILITY: hidden; COLOR: white"><s:actionerror/></SPAN></TD></TR>
	...
	<td><span class="fieldSet"> <input type="text"id="checkcode" name="checkcode" class="text captcha"
